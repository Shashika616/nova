          ...
          {Object.keys(themes).map((name) => (
            <button
              ...
              style={{
                ...
                background: themes[name as keyof typeof themes].colors.surface,
                boxShadow: themeName === name ? `0 0 20px ${theme.colors.primary}40` : "none",
              }}
              title={name}
            />
          ))}
        ...
        >
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button 
              ...
              style={{
                background: loading ? theme.colors.muted : `linear-gradient(135deg, ${theme.colors.primary}, ${theme.colors.secondary})`,
              }}
            >
              {loading ? (
